 ...
 * Register sidebar
 */
function marionetterna_widgets_init() {
    register_sidebar(array(
        'name' => __('Sidebar widgets', 'marionetterna'),
        'id' => 'sidebar-1',
        'class' => 'custom',
...
add_action('widgets_init', 'marionetterna_widgets_init');
...
function theme_styles() {
    ...
    wp_enqueue_style('theme_fonts', 'http://fonts.googleapis.com/css?family=Lato:300,400,700,900|Open+Sans:400,300,600,700|Source+Sans+Pro:200,normal,300,600,700');
    wp_enqueue_style('theme_style', get_template_directory_uri() . '/css/style.css');
    wp_enqueue_style('theme_font-awesome', get_template_directory_uri() . '/assets/font-awesome/font-awesome.min.css');
}
